...
public class LoadedScreen extends BaseScreen {
	...
	public LoadedScreen(MyGame g, PauseMenuScreen pm, String s) {
	...
	public LoadedScreen(MyGame g, MainMenuScreen _ms, String s) {
	...
	// Costruttore per pauseMenuScreen
	public LoadedScreen(MyGame g, PauseMenuScreen pm) {
